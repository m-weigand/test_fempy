 ...
 * Generation date: Sat Apr  5 07:20:38 2025
...
static PyObject *mxfem_error;
static PyObject *mxfem_module;
...
/**************************** forward_calculation ****************************/
static char doc_f2py_rout_mxfem_fem_pyw_forward_calculation[] = "\
forward_calculation()\n\nWrapper for ``forward_calculation``.\
\n";
/*  */
static PyObject *f2py_rout_mxfem_fem_pyw_forward_calculation(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
    ...
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "|:mxfem.fem_pyw.forward_calculation",\
        capi_kwlist))
        return NULL;
/*frompyobj*/
/*end of frompyobj*/
...
static FortranDataDef f2py_elemmod_def[] = {
  ...
  {"sx",1,{{-1}},NPY_FLOAT, 1},
  {"sy",1,{{-1}},NPY_FLOAT, 1},
  {"espx",1,{{-1}},NPY_FLOAT, 1},
  {"espy",1,{{-1}},NPY_FLOAT, 1},
  ...
  {"esp_min",0,{{-1}},NPY_FLOAT, 1},
  {"esp_max",0,{{-1}},NPY_FLOAT, 1},
  {"esp_mit",0,{{-1}},NPY_FLOAT, 1},
  {"esp_med",0,{{-1}},NPY_FLOAT, 1},
  {"esp_std",0,{{-1}},NPY_FLOAT, 1},
  {"grid_min",0,{{-1}},NPY_FLOAT, 1},
  {"grid_max",0,{{-1}},NPY_FLOAT, 1},
  {"grid_minx",0,{{-1}},NPY_FLOAT, 1},
  {"grid_miny",0,{{-1}},NPY_FLOAT, 1},
  {"grid_maxx",0,{{-1}},NPY_FLOAT, 1},
  {"grid_maxy",0,{{-1}},NPY_FLOAT, 1},
  {"lsink",0,{{-1}},NPY_INT, 1},
  {"nsink",0,{{-1}},NPY_INT, 1},
  {"lrandb2",0,{{-1}},NPY_INT, 1},
  {"sytop",0,{{-1}},NPY_FLOAT, 1},
  {"xk",1,{{-1}},NPY_FLOAT, 1},
  {"yk",1,{{-1}},NPY_FLOAT, 1},
  {"elmam",2,{{-1,-1}},NPY_FLOAT, 1},
  {"elmas",2,{{-1,-1}},NPY_FLOAT, 1},
  {"elve",1,{{-1}},NPY_FLOAT, 1},
  {"decexi",0,{{-1}},NPY_INT, 1},
  {"edecoup",2,{{-1,-1}},NPY_INT, 1},
  {"edecstr",1,{{-1}},NPY_FLOAT, 1},
  {"decanz",0,{{-1}},NPY_INT, 1},
  {"nr_elec_capacitances",0,{{-1}},NPY_INT, 1},
  {"elec_caps_file_exists",0,{{-1}},NPY_INT, 1},
  {"electrode_capacitances",1,{{-1}},NPY_FLOAT, 1},
  {NULL}
};
...
static FortranDataDef f2py_alloci_def[] = {
  ...
  {"csens",1,{{-1}},NPY_FLOAT, 1},
  {"adc",1,{{-1}},NPY_FLOAT, 1},
  {"kpotdc",3,{{-1,-1,-1}},NPY_FLOAT, 1},
  {"hpotdc",2,{{-1,-1}},NPY_FLOAT, 1},
  {"sensdc",2,{{-1,-1}},NPY_FLOAT, 1},
  {"cov_d",2,{{-1,-1}},NPY_FLOAT, 1},
  {"smatm",2,{{-1,-1}},NPY_FLOAT, 1},
  {"rnd_r",1,{{-1}},NPY_FLOAT, 1},
  {"rnd_p",1,{{-1}},NPY_FLOAT, 1},
  {"ata",2,{{-1,-1}},NPY_FLOAT, 1},
  {"ata_reg",2,{{-1,-1}},NPY_FLOAT, 1},
  {"cov_m",2,{{-1,-1}},NPY_FLOAT, 1},
  {NULL}
};
...
static FortranDataDef f2py_femmod_def[] = {
  ...
  {"bdc",1,{{-1}},NPY_FLOAT, 1},
  {"fak",1,{{-1}},NPY_FLOAT, 1},
  {"elbg",3,{{-1,-1,-1}},NPY_FLOAT, 1},
  {"relbg",2,{{-1,-1}},NPY_FLOAT, 1},
  {"kg",3,{{-1,-1,-1}},NPY_FLOAT, 1},
  {"lbeta",0,{{-1}},NPY_INT, 1},
...
static FortranDataDef f2py_datmod_def[] = {
  {"nanz",0,{{-1}},NPY_INT, 1},
  {"strnr",1,{{-1}},NPY_INT, 1},
  {"strom",1,{{-1}},NPY_FLOAT, 1},
  {"vnr",1,{{-1}},NPY_INT, 1},
  {"volt",1,{{-1}},NPY_CFLOAT, 1},
  {"sigmaa",1,{{-1}},NPY_CFLOAT, 1},
  {"sgmaa2",1,{{-1}},NPY_CFLOAT, 1},
  {"kfak",1,{{-1}},NPY_FLOAT, 1},
  {"wmatdp",1,{{-1}},NPY_FLOAT, 1},
  {"wmatdr",1,{{-1}},NPY_FLOAT, 1},
  {"wmatd_cri",1,{{-1}},NPY_FLOAT, 1},
  {"stabw0",0,{{-1}},NPY_FLOAT, 1},
  {"stabm0",0,{{-1}},NPY_FLOAT, 1},
  {"stabp0",0,{{-1}},NPY_FLOAT, 1},
  {"stabpa1",0,{{-1}},NPY_FLOAT, 1},
  {"stabpb",0,{{-1}},NPY_FLOAT, 1},
  {"stabpa2",0,{{-1}},NPY_FLOAT, 1},
  ...
  {"lnse2",0,{{-1}},NPY_INT, 1},
  {"iseed",0,{{-1}},NPY_INT, 1},
  {"nstabw0",0,{{-1}},NPY_FLOAT, 1},
  {"nstabm0",0,{{-1}},NPY_FLOAT, 1},
  {"nstabpb",0,{{-1}},NPY_FLOAT, 1},
  {"nstabpa1",0,{{-1}},NPY_FLOAT, 1},
  {"nstabpa2",0,{{-1}},NPY_FLOAT, 1},
  {"nstabp0",0,{{-1}},NPY_FLOAT, 1},
  {"npol",0,{{-1}},NPY_INT, 1},
  {NULL}
};
...
static FortranDataDef f2py_sigmamod_def[] = {
  ...
  {"bet0",0,{{-1}},NPY_FLOAT, 1},
  {"pha0",0,{{-1}},NPY_FLOAT, 1},
  {"lrho0",0,{{-1}},NPY_INT, 1},
  {"lstart",0,{{-1}},NPY_INT, 1},
  {"iseedpri",0,{{-1}},NPY_INT, 1},
  {"modl_stdn",0,{{-1}},NPY_FLOAT, 1},
  {NULL}
};
...
static FortranDataDef f2py_modelmod_def[] = {
  {"manz",0,{{-1}},NPY_INT, 1},
  {"mnr",1,{{-1}},NPY_INT, 1},
  {"w_ref_re",1,{{-1}},NPY_FLOAT, 1},
  {"w_ref_im",1,{{-1}},NPY_FLOAT, 1},
...
static FortranDataDef f2py_invmod_def[] = {
  ...
  {"wmatd",1,{{-1}},NPY_FLOAT, 1},
  {"wmatd2",1,{{-1}},NPY_FLOAT, 1},
  {"par_vari",0,{{-1}},NPY_FLOAT, 1},
  {"wdfak",1,{{-1}},NPY_INT, 1},
  {"lfpi",0,{{-1}},NPY_INT, 1},
  {"wmfak",1,{{-1}},NPY_INT, 1},
  {NULL}
...
static FortranDataDef f2py_wavenmod_def[] = {
  ...
  {"swrtr",0,{{-1}},NPY_INT, 1},
  {"kwn",1,{{-1}},NPY_FLOAT, 1},
  {"kwnwi",1,{{-1}},NPY_FLOAT, 1},
  {"amin",0,{{-1}},NPY_FLOAT, 1},
  {"amax",0,{{-1}},NPY_FLOAT, 1},
  {NULL}
};
...
static FortranDataDef f2py_konvmod_def[] = {
  {"lam",0,{{-1}},NPY_FLOAT, 1},
  {"lammax",0,{{-1}},NPY_FLOAT, 1},
  {"lam_cri",0,{{-1}},NPY_FLOAT, 1},
  {"lamnull_cri",0,{{-1}},NPY_FLOAT, 1},
  {"lamnull_fpi",0,{{-1}},NPY_FLOAT, 1},
  {"lam_ref",0,{{-1}},NPY_FLOAT, 1},
  {"lam_ref_sw",0,{{-1}},NPY_INT, 1},
  {"lamfix",0,{{-1}},NPY_FLOAT, 1},
  {"dlam",0,{{-1}},NPY_FLOAT, 1},
  {"dlalt",0,{{-1}},NPY_FLOAT, 1},
  {"nlam",0,{{-1}},NPY_INT, 1},
  {"alam",0,{{-1}},NPY_FLOAT, 1},
  {"fstart",0,{{-1}},NPY_FLOAT, 1},
  {"fstop",0,{{-1}},NPY_FLOAT, 1},
  {"step",0,{{-1}},NPY_FLOAT, 1},
  {"stpalt",0,{{-1}},NPY_FLOAT, 1},
  {"stpmin",0,{{-1}},NPY_FLOAT, 1},
  {"llam",0,{{-1}},NPY_INT, 1},
  {"lstep",0,{{-1}},NPY_INT, 1},
  ...
  {"nrmsd",0,{{-1}},NPY_FLOAT, 1},
  {"rmsalt",0,{{-1}},NPY_FLOAT, 1},
  {"rmsreg",0,{{-1}},NPY_FLOAT, 1},
  {"rmssum",0,{{-1}},NPY_FLOAT, 1},
  {"betrms",0,{{-1}},NPY_FLOAT, 1},
  {"pharms",0,{{-1}},NPY_FLOAT, 1},
  {"rough",0,{{-1}},NPY_FLOAT, 1},
  {"nrmsdm",0,{{-1}},NPY_FLOAT, 1},
  {"mqrms",0,{{-1}},NPY_FLOAT, 1},
  {"l1min",0,{{-1}},NPY_FLOAT, 1},
  {"l1rat",0,{{-1}},NPY_FLOAT, 1},
  {"bdpar",0,{{-1}},NPY_FLOAT, 1},
  {"bdmin",0,{{-1}},NPY_FLOAT, 1},
  {"nx",0,{{-1}},NPY_INT, 1},
  {"nz",0,{{-1}},NPY_INT, 1},
  {"itmax",0,{{-1}},NPY_INT, 1},
  {"it",0,{{-1}},NPY_INT, 1},
  {"itr",0,{{-1}},NPY_INT, 1},
  {"alfx",0,{{-1}},NPY_FLOAT, 1},
  {"alfz",0,{{-1}},NPY_FLOAT, 1},
  {"betamgs",0,{{-1}},NPY_FLOAT, 1},
...
static FortranDataDef f2py_fem_pyw_def[] = {
  {"pi",0,{{-1}},NPY_FLOAT, 1},
  {"radius",0,{{-1}},NPY_FLOAT, 1},
  {"forward_calculation",-1,{{-1}},0,0,NULL,(void *)f2py_rout_mxfem_fem_pyw_forward_calculation,doc_f2py_rout_mxfem_fem_pyw_forward_calculation},
  {NULL}
};

static void f2py_setup_fem_pyw(char *pi,char *radius,char *forward_calculation) {
  int i_f2py=0;
  f2py_fem_pyw_def[i_f2py++].data = pi;
  f2py_fem_pyw_def[i_f2py++].data = radius;
  f2py_fem_pyw_def[i_f2py++].data = forward_calculation;
}
extern void F_FUNC_US(f2pyinitfem_pyw,F2PYINITFEM_PYW)(void (*)(char*,char*,char *));
...
#ifdef F2PY_REPORT_ATEXIT
    if (! PyErr_Occurred())
        on_exit(f2py_report_on_exit,(void*)"mxfem");
#endif
